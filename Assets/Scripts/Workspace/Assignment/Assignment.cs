...
namespace Assignment
{
    public class Assignment : MonoBehaviour
    {
        ...
        [SerializeField]
        private IntLinkedListInput as04List =
        ...
        [SerializeField]
        private StringLinkedListInput as05List =
        ...
        [SerializeField]
        private StringIntDictionaryInput as06FirstDictionary =
            new StringIntDictionaryInput();

        [SerializeField]
        private StringIntDictionaryInput as06SecondDictionary =
            new StringIntDictionaryInput();
        ...
        [SerializeField]
        private IntLinkedListInput as07List =
            new IntLinkedListInput();
        ...
        public void AS08_TopFrequentNumber()
        {
            ...
            int topCount = frequency[topNumber];
        ...
        [SerializeField]
        private StringIntDictionaryInput as09Inventory =
            new StringIntDictionaryInput();
        ...
        [SerializeField]
        private GameEventLinkedListInput as10EventQueue =
        ...
        public void AS10_GameEventQueue()
        {
            ...
            while (eventQueue.Count > 0)
            {
                GameEvent currentEvent =
                    eventQueue.First.Value;

                eventQueue.RemoveFirst();

                Debug.Log(
                    $"Processing event: {currentEvent.Name}"
                );

                Debug.Log(
                    $"Remaining events in queue: {eventQueue.Count}"
                );
        ...
        [SerializeField]
        private StringIntDictionaryInput as11PlayerStats =
            new StringIntDictionaryInput();
